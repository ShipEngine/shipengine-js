...
export function WarehouseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Warehouse {
    ...
    return {
        ...
        'originAddress': !exists(json, 'origin_address') ? undefined : AddressFromJSON(json['origin_address']),
        'returnAddress': !exists(json, 'return_address') ? undefined : AddressFromJSON(json['return_address']),
    };
}
...
export function WarehouseToJSON(value?: Warehouse | null): any {
    ...
    return {
        ...
        'name': value.name,
        'origin_address': AddressToJSON(value.originAddress),
        'return_address': AddressToJSON(value.returnAddress),
    };
}
