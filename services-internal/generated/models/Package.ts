...
import {
    ...
    DimensionsToJSON,
    LabelMessages,
    LabelMessagesFromJSON,
    LabelMessagesFromJSONTyped,
    LabelMessagesToJSON,
    MonetaryValue,
...
export function PackageFromJSONTyped(json: any, ignoreDiscriminator: boolean): Package {
    ...
    return {
        ...
        'insuredValue': !exists(json, 'insured_value') ? undefined : MonetaryValueFromJSON(json['insured_value']),
        'trackingNumber': !exists(json, 'tracking_number') ? undefined : json['tracking_number'],
        'labelMessages': !exists(json, 'label_messages') ? undefined : LabelMessagesFromJSON(json['label_messages']),
...
export function PackageToJSON(value?: Package | null): any {
    ...
    return {
        ...
        'insured_value': MonetaryValueToJSON(value.insuredValue),
        'label_messages': LabelMessagesToJSON(value.labelMessages),
