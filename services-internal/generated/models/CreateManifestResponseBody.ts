...
import {
    DeprecatedManifest,
    DeprecatedManifestFromJSON,
    DeprecatedManifestFromJSONTyped,
    DeprecatedManifestToJSON,
    ErrorResponseBody,
...
export function CreateManifestResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateManifestResponseBody {
    ...
    return {
        ...
        'manifests': !exists(json, 'manifests') ? undefined : ((json['manifests'] as Array<any>).map(ManifestFromJSON)),
        ...
        'manifestDownload': ManifestDownloadFromJSON(json['manifest_download']),
...
export function CreateManifestResponseBodyToJSON(value?: CreateManifestResponseBody | null): any {
    ...
    return {
        ...
        'manifests': value.manifests === undefined ? undefined : ((value.manifests as Array<any>).map(ManifestToJSON)),
