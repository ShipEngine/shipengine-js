 ...
 */
export interface GetShipmentByIdResponseBody extends Shipment {
}

export function GetShipmentByIdResponseBodyFromJSON(json: any): GetShipmentByIdResponseBody {
    return GetShipmentByIdResponseBodyFromJSONTyped(json, false);
}

export function GetShipmentByIdResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetShipmentByIdResponseBody {
    return json;
}

export function GetShipmentByIdResponseBodyToJSON(value?: GetShipmentByIdResponseBody | null): any {
    return value;
}
