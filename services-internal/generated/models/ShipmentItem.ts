...
export function ShipmentItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShipmentItem {
    ...
    return {
        ...
        'salesOrderId': !exists(json, 'sales_order_id') ? undefined : json['sales_order_id'],
        'salesOrderItemId': !exists(json, 'sales_order_item_id') ? undefined : json['sales_order_item_id'],
        'quantity': !exists(json, 'quantity') ? undefined : json['quantity'],
        'sku': !exists(json, 'sku') ? undefined : json['sku'],
        'externalOrderId': !exists(json, 'external_order_id') ? undefined : json['external_order_id'],
        'externalOrderItemId': !exists(json, 'external_order_item_id') ? undefined : json['external_order_item_id'],
...
export function ShipmentItemToJSON(value?: ShipmentItem | null): any {
    ...
    return {
        ...
        'sales_order_item_id': value.salesOrderItemId,
        'quantity': value.quantity,
        'sku': value.sku,
        'external_order_id': value.externalOrderId,
        'external_order_item_id': value.externalOrderItemId,
        'asin': value.asin,
