...
export function ParseShipmentResponseBodyFromJSON(json: any): ParseShipmentResponseBody {
    return ParseShipmentResponseBodyFromJSONTyped(json, false);
}

export function ParseShipmentResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseShipmentResponseBody {
    ...
    return {
        ...
        'score': json['score'],
        'shipment': PartialShipmentFromJSON(json['shipment']),
        'entities': ((json['entities'] as Array<any>).map(RecognizedEntityFromJSON)),
    };
}

export function ParseShipmentResponseBodyToJSON(value?: ParseShipmentResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
