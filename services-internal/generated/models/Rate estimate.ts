 ...
 * A rate estimate
 * @export
 * @interface Rate estimate
 */
export interface Rate estimate {
    /**
     * 
     * @type {RateType}
     * @memberof Rate estimate
     */
     ...
     * @memberof Rate estimate
     */
    readonly shippingAmount: MonetaryValue;
    /**
     * The insurance amount
     * @type {MonetaryValue}
     * @memberof Rate estimate
     */
    readonly insuranceAmount: MonetaryValue;
    /**
     * The confirmation amount
     * @type {MonetaryValue}
     * @memberof Rate estimate
     */
    readonly confirmationAmount: MonetaryValue;
    /**
     * Any other charges associated with this rate
     * @type {MonetaryValue}
     * @memberof Rate estimate
     */
    readonly otherAmount: MonetaryValue;
    /**
     * Tariff and additional taxes associated with an international shipment.
     * @type {MonetaryValue}
     * @memberof Rate estimate
     */
    readonly taxAmount?: MonetaryValue;
    /**
...
export function Rate estimateFromJSON(json: any): Rate estimate {
    return Rate estimateFromJSONTyped(json, false);
}

export function Rate estimateFromJSONTyped(json: any, ignoreDiscriminator: boolean): Rate estimate {
    ...
    return {
        ...
        'shippingAmount': MonetaryValueFromJSON(json['shipping_amount']),
        'insuranceAmount': MonetaryValueFromJSON(json['insurance_amount']),
        'confirmationAmount': MonetaryValueFromJSON(json['confirmation_amount']),
        'otherAmount': MonetaryValueFromJSON(json['other_amount']),
        'taxAmount': !exists(json, 'tax_amount') ? undefined : MonetaryValueFromJSON(json['tax_amount']),
        'zone': json['zone'],
        ...
        'validationStatus': ValidationStatusFromJSON(json['validation_status']),
        'warningMessages': json['warning_messages'],
        'errorMessages': json['error_messages'],
    };
}

export function Rate estimateToJSON(value?: Rate estimate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
