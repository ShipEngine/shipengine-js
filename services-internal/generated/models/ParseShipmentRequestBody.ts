...
export function ParseShipmentRequestBodyFromJSON(json: any): ParseShipmentRequestBody {
    return ParseShipmentRequestBodyFromJSONTyped(json, false);
}

export function ParseShipmentRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseShipmentRequestBody {
    ...
    return {
        ...
        'text': json['text'],
        'shipment': !exists(json, 'shipment') ? undefined : PartialShipmentFromJSON(json['shipment']),
    };
}

export function ParseShipmentRequestBodyToJSON(value?: ParseShipmentRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'text': value.text,
        'shipment': PartialShipmentToJSON(value.shipment),
    };
}
