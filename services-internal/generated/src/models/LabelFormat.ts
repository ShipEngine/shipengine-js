...
export function LabelFormatFromJSON(json: any): LabelFormat {
    return LabelFormatFromJSONTyped(json, false);
}

export function LabelFormatFromJSONTyped(json: any, ignoreDiscriminator: boolean): LabelFormat {
    return json as LabelFormat;
}

export function LabelFormatToJSON(value?: LabelFormat | null): any {
    return value as any;
}
