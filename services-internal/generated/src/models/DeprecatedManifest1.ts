 ...
 * @export
 * @interface DeprecatedManifest1
 */
export interface DeprecatedManifest1 {
    /**
     * A string that uniquely identifies the manifest
     * @type {string}
     * @memberof DeprecatedManifest1
     */
    manifestId?: string;
    /**
...
export function DeprecatedManifest1FromJSON(json: any): DeprecatedManifest1 {
    return DeprecatedManifest1FromJSONTyped(json, false);
}

export function DeprecatedManifest1FromJSONTyped(json: any, ignoreDiscriminator: boolean): DeprecatedManifest1 {
...
export function DeprecatedManifest1ToJSON(value?: DeprecatedManifest1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
