...
export function PurchaseLabelWithoutShipmentFromJSON(json: any): PurchaseLabelWithoutShipment {
    return PurchaseLabelWithoutShipmentFromJSONTyped(json, false);
}

export function PurchaseLabelWithoutShipmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): PurchaseLabelWithoutShipment {
...
export function PurchaseLabelWithoutShipmentToJSON(value?: PurchaseLabelWithoutShipment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
