...
import {
    ...
    CarrierAdvancedOptionFromJSON,
    CarrierAdvancedOptionFromJSONTyped,
    CarrierAdvancedOptionToJSON,
    PackageType,
    PackageTypeFromJSON,
...
export function CarrierFromJSONTyped(json: any, ignoreDiscriminator: boolean): Carrier {
    ...
    return {
        ...
        'packages': !exists(json, 'packages') ? undefined : ((json['packages'] as Array<any>).map(PackageTypeFromJSON)),
        'options': !exists(json, 'options') ? undefined : ((json['options'] as Array<any>).map(CarrierAdvancedOptionFromJSON)),
    };
}
