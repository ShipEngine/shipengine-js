...
export function RecognizedEntityFromJSON(json: any): RecognizedEntity {
    return RecognizedEntityFromJSONTyped(json, false);
}

export function RecognizedEntityFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecognizedEntity {
...
export function RecognizedEntityToJSON(value?: RecognizedEntity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
