 ...
 * @enum {string}
 */
export enum LabelDownloadType {
    Url = 'url',
    Inline = 'inline'
}

export function LabelDownloadTypeFromJSON(json: any): LabelDownloadType {
    return LabelDownloadTypeFromJSONTyped(json, false);
}

export function LabelDownloadTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LabelDownloadType {
    return json as LabelDownloadType;
}

export function LabelDownloadTypeToJSON(value?: LabelDownloadType | null): any {
    return value as any;
}
