...
export function LabelMessagesFromJSON(json: any): LabelMessages {
    return LabelMessagesFromJSONTyped(json, false);
}

export function LabelMessagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): LabelMessages {
...
export function LabelMessagesToJSON(value?: LabelMessages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
