...
export function ConnectCanadaPostRequestBodyFromJSON(json: any): ConnectCanadaPostRequestBody {
    return ConnectCanadaPostRequestBodyFromJSONTyped(json, false);
}

export function ConnectCanadaPostRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectCanadaPostRequestBody {
...
export function ConnectCanadaPostRequestBodyToJSON(value?: ConnectCanadaPostRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
