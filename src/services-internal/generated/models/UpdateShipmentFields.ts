...
export function UpdateShipmentFieldsFromJSON(json: any): UpdateShipmentFields {
    return UpdateShipmentFieldsFromJSONTyped(json, false);
}

export function UpdateShipmentFieldsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateShipmentFields {
...
export function UpdateShipmentFieldsToJSON(value?: UpdateShipmentFields | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
