...
import {
    ...
    ValidateShipmentFieldsFromJSON,
    ValidateShipmentFieldsFromJSONTyped,
    ValidateShipmentFieldsToJSON,
    Weight,
    WeightFromJSON,
    WeightFromJSONTyped,
    WeightToJSON,
...
export function AddressValidatingShipmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressValidatingShipment {
    ...
    return {
        ...
        'shipTo': AddressFromJSON(json['ship_to']),
        'shipFrom': AddressFromJSON(json['ship_from']),
