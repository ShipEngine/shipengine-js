...
export function PagedListResponseBodyFromJSON(json: any): PagedListResponseBody {
    return PagedListResponseBodyFromJSONTyped(json, false);
}

export function PagedListResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PagedListResponseBody {
...
export function PagedListResponseBodyToJSON(value?: PagedListResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'page': value.page,
        'pages': value.pages,
        'links': PaginationLinkToJSON(value.links),
    };
}
