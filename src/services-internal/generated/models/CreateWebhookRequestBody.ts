...
export function CreateWebhookRequestBodyFromJSON(json: any): CreateWebhookRequestBody {
    return CreateWebhookRequestBodyFromJSONTyped(json, false);
}

export function CreateWebhookRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWebhookRequestBody {
...
export function CreateWebhookRequestBodyToJSON(value?: CreateWebhookRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
