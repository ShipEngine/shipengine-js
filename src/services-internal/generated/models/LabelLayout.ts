...
export function LabelLayoutFromJSON(json: any): LabelLayout {
    return LabelLayoutFromJSONTyped(json, false);
}

export function LabelLayoutFromJSONTyped(json: any, ignoreDiscriminator: boolean): LabelLayout {
    return json as LabelLayout;
}

export function LabelLayoutToJSON(value?: LabelLayout | null): any {
    return value as any;
}
