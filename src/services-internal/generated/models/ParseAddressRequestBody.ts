...
export function ParseAddressRequestBodyFromJSON(json: any): ParseAddressRequestBody {
    return ParseAddressRequestBodyFromJSONTyped(json, false);
}

export function ParseAddressRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseAddressRequestBody {
    ...
    return {
        ...
        'text': json['text'],
        'address': !exists(json, 'address') ? undefined : PartialAddressFromJSON(json['address']),
    };
}

export function ParseAddressRequestBodyToJSON(value?: ParseAddressRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
