...
import {
    ...
    RateResponseFromJSONTyped,
    RateResponseToJSON,
    RatesInformation,
    RatesInformationFromJSON,
    RatesInformationFromJSONTyped,
    RatesInformationToJSON,
    ShipmentItem,
...
export function CalculateRatesResponseBodyFromJSON(json: any): CalculateRatesResponseBody {
    return CalculateRatesResponseBodyFromJSONTyped(json, false);
}

export function CalculateRatesResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CalculateRatesResponseBody {
    ...
    return {
        ...
        'shipmentStatus': ShipmentStatusFromJSON(json['shipment_status']),
        ...
        'returnTo': AddressFromJSON(json['return_to']),
        'confirmation': DeliveryConfirmationFromJSON(json['confirmation']),
        'customs': InternationalShipmentOptionsFromJSON(json['customs']),
        'advancedOptions': AdvancedShipmentOptionsFromJSON(json['advanced_options']),
        'insuranceProvider': InsuranceProviderFromJSON(json['insurance_provider']),
        ...
        'totalWeight': WeightFromJSON(json['total_weight']),
        'rateResponse': RatesInformationFromJSON(json['rate_response']),
    };
}

export function CalculateRatesResponseBodyToJSON(value?: CalculateRatesResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'rate_response': RatesInformationToJSON(value.rateResponse),
    };
}
