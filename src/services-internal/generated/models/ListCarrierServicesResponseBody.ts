...
export function ListCarrierServicesResponseBodyFromJSON(json: any): ListCarrierServicesResponseBody {
    return ListCarrierServicesResponseBodyFromJSONTyped(json, false);
}

export function ListCarrierServicesResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListCarrierServicesResponseBody {
...
export function ListCarrierServicesResponseBodyToJSON(value?: ListCarrierServicesResponseBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
