...
export interface Service {
     ...
     * @memberof Service
     */
    readonly isMultiPackageSupported?: boolean;
}
...
export function ServiceFromJSONTyped(json: any, ignoreDiscriminator: boolean): Service {
    ...
    return {
        ...
        'domestic': !exists(json, 'domestic') ? undefined : json['domestic'],
        'international': !exists(json, 'international') ? undefined : json['international'],
        'isMultiPackageSupported': !exists(json, 'is_multi_package_supported') ? undefined : json['is_multi_package_supported'],
    };
}
