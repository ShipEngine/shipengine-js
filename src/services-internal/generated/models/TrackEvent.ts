...
export function TrackEventFromJSON(json: any): TrackEvent {
    return TrackEventFromJSONTyped(json, false);
}

export function TrackEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackEvent {
...
export function TrackEventToJSON(value?: TrackEvent | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
