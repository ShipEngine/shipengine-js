 ...
 */
export interface UpdateShipmentResponseBody extends CreateAndValidateShipment {
}

export function UpdateShipmentResponseBodyFromJSON(json: any): UpdateShipmentResponseBody {
    return UpdateShipmentResponseBodyFromJSONTyped(json, false);
}

export function UpdateShipmentResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateShipmentResponseBody {
    return json;
}

export function UpdateShipmentResponseBodyToJSON(value?: UpdateShipmentResponseBody | null): any {
    return value;
}
