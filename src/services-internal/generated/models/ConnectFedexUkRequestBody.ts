...
export function ConnectFedexUkRequestBodyFromJSON(json: any): ConnectFedexUkRequestBody {
    return ConnectFedexUkRequestBodyFromJSONTyped(json, false);
}

export function ConnectFedexUkRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectFedexUkRequestBody {
...
export function ConnectFedexUkRequestBodyToJSON(value?: ConnectFedexUkRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
