...
export function Package1FromJSON(json: any): Package1 {
    return Package1FromJSONTyped(json, false);
}

export function Package1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Package1 {
...
export function Package1ToJSON(value?: Package1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
