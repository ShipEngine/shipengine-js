 ...
 * @export
 * @interface ProcessBatchRequestBody1
 */
export interface ProcessBatchRequestBody1 {
    /**
     * The Ship date the batch is being processed for
     * @type {Date}
     * @memberof ProcessBatchRequestBody1
     */
    shipDate?: Date;
    /**
     * 
...
export function ProcessBatchRequestBody1FromJSON(json: any): ProcessBatchRequestBody1 {
    return ProcessBatchRequestBody1FromJSONTyped(json, false);
}

export function ProcessBatchRequestBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ProcessBatchRequestBody1 {
...
export function ProcessBatchRequestBody1ToJSON(value?: ProcessBatchRequestBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
