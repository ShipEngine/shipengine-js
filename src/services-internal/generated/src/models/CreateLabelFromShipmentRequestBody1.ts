 ...
 * @export
 * @interface CreateLabelFromShipmentRequestBody1
 */
export interface CreateLabelFromShipmentRequestBody1 {
    /**
     * 
     * @type {string}
     * @memberof CreateLabelFromShipmentRequestBody1
     */
...
export function CreateLabelFromShipmentRequestBody1FromJSON(json: any): CreateLabelFromShipmentRequestBody1 {
    return CreateLabelFromShipmentRequestBody1FromJSONTyped(json, false);
}

export function CreateLabelFromShipmentRequestBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateLabelFromShipmentRequestBody1 {
...
export function CreateLabelFromShipmentRequestBody1ToJSON(value?: CreateLabelFromShipmentRequestBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
