 ...
 * @export
 * @interface PagedListResponseBody1
 */
export interface PagedListResponseBody1 {
    /**
     * The total number of items across all pages of results
     * @type {number}
     * @memberof PagedListResponseBody1
     */
    total: number;
    /**
...
export function PagedListResponseBody1FromJSON(json: any): PagedListResponseBody1 {
    return PagedListResponseBody1FromJSONTyped(json, false);
}

export function PagedListResponseBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PagedListResponseBody1 {
...
export function PagedListResponseBody1ToJSON(value?: PagedListResponseBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
