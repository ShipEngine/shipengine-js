...
import {
    PartialShipment1,
    PartialShipment1FromJSON,
    PartialShipment1FromJSONTyped,
    PartialShipment1ToJSON,
    ValidateShipmentFields1,
    ValidateShipmentFields1FromJSON,
    ValidateShipmentFields1FromJSONTyped,
    ValidateShipmentFields1ToJSON,
} from './';
...
export function AddressValidatingShipmentFromJSON(json: any): AddressValidatingShipment {
    return AddressValidatingShipmentFromJSONTyped(json, false);
}

export function AddressValidatingShipmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddressValidatingShipment {
...
export function AddressValidatingShipmentToJSON(value?: AddressValidatingShipment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
