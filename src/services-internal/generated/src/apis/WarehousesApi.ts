...
import {
    ...
    ListWarehousesResponseBody1,
    ListWarehousesResponseBody1FromJSON,
    ListWarehousesResponseBody1ToJSON,
    UNKNOWN_BASE_TYPE,
...
export class WarehousesApi extends runtime.BaseAPI {
     ...
     * Create Warehouse
     */
    async createWarehouseRaw(requestParameters: CreateWarehouseRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.uNKNOWNBASETYPE === null || requestParameters.uNKNOWNBASETYPE === undefined) {
            throw new runtime.RequiredError('uNKNOWNBASETYPE','Required parameter requestParameters.uNKNOWNBASETYPE was null or undefined when calling createWarehouse.');
        }
     ...
     * Create Warehouse
     */
    async createWarehouse(requestParameters: CreateWarehouseRequest): Promise<object> {
     ...
     * Get Warehouse By Id
     */
    async getWarehouseByIdRaw(requestParameters: GetWarehouseByIdRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.warehouseId === null || requestParameters.warehouseId === undefined) {
     ...
     * Get Warehouse By Id
     */
    async getWarehouseById(requestParameters: GetWarehouseByIdRequest): Promise<object> {
     ...
     * List Warehouses
     */
    async listWarehousesRaw(): Promise<runtime.ApiResponse<ListWarehousesResponseBody1>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListWarehousesResponseBody1FromJSON(jsonValue));
    }
     ...
     * List Warehouses
     */
    async listWarehouses(): Promise<ListWarehousesResponseBody1> {
    ...
    async updateWarehouseRaw(requestParameters: UpdateWarehouseRequest): Promise<runtime.ApiResponse<string>> {
        ...
        if (requestParameters.uNKNOWNBASETYPE === null || requestParameters.uNKNOWNBASETYPE === undefined) {
            throw new runtime.RequiredError('uNKNOWNBASETYPE','Required parameter requestParameters.uNKNOWNBASETYPE was null or undefined when calling updateWarehouse.');
        }
