...
import {
    ...
    CarrierNameWithSettingsFromJSON,
    CarrierNameWithSettingsToJSON,
    ConnectCarrierRequestBody,
    ConnectCarrierRequestBodyFromJSON,
    ConnectCarrierRequestBodyToJSON,
    ConnectCarrierResponseBody,
    ConnectCarrierResponseBodyFromJSON,
    ConnectCarrierResponseBodyToJSON,
    ErrorResponseBody,
    ErrorResponseBodyFromJSON,
    ErrorResponseBodyToJSON,
    GetCarrierSettingsResponseBody,
    GetCarrierSettingsResponseBodyFromJSON,
    GetCarrierSettingsResponseBodyToJSON,
    UpdateCarrierSettingsRequestBody,
    UpdateCarrierSettingsRequestBodyFromJSON,
    UpdateCarrierSettingsRequestBodyToJSON,
} from '../models';
...
export class CarrierAccountsApi extends runtime.BaseAPI {
     ...
     * Connect a carrier account
     */
    async connectCarrierRaw(requestParameters: ConnectCarrierRequest): Promise<runtime.ApiResponse<ConnectCarrierResponseBody>> {
        ...
        if (requestParameters.connectCarrierRequestBody === null || requestParameters.connectCarrierRequestBody === undefined) {
            throw new runtime.RequiredError('connectCarrierRequestBody','Required parameter requestParameters.connectCarrierRequestBody was null or undefined when calling connectCarrier.');
        }
        ...
        const response = await this.request({
            ...
            body: ConnectCarrierRequestBodyToJSON(requestParameters.connectCarrierRequestBody),
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => ConnectCarrierResponseBodyFromJSON(jsonValue));
    }
     ...
     * Connect a carrier account
     */
    async connectCarrier(requestParameters: ConnectCarrierRequest): Promise<ConnectCarrierResponseBody> {
     ...
     * Get carrier settings
     */
    async getCarrierSettingsRaw(requestParameters: GetCarrierSettingsRequest): Promise<runtime.ApiResponse<GetCarrierSettingsResponseBody>> {
        if (requestParameters.carrierName === null || requestParameters.carrierName === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetCarrierSettingsResponseBodyFromJSON(jsonValue));
    }
     ...
     * Get carrier settings
     */
    async getCarrierSettings(requestParameters: GetCarrierSettingsRequest): Promise<GetCarrierSettingsResponseBody> {
    ...
    async updateCarrierSettingsRaw(requestParameters: UpdateCarrierSettingsRequest): Promise<runtime.ApiResponse<string>> {
        ...
        if (requestParameters.updateCarrierSettingsRequestBody === null || requestParameters.updateCarrierSettingsRequestBody === undefined) {
            throw new runtime.RequiredError('updateCarrierSettingsRequestBody','Required parameter requestParameters.updateCarrierSettingsRequestBody was null or undefined when calling updateCarrierSettings.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateCarrierSettingsRequestBodyToJSON(requestParameters.updateCarrierSettingsRequestBody),
        });
