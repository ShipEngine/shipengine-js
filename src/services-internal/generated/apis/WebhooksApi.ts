...
import {
    ...
    CreateWebhookResponseBodyFromJSON,
    CreateWebhookResponseBodyToJSON,
    ErrorResponseBody,
    ErrorResponseBodyFromJSON,
    ErrorResponseBodyToJSON,
    GetWebhookByIdResponseBody,
    GetWebhookByIdResponseBodyFromJSON,
    GetWebhookByIdResponseBodyToJSON,
...
export class WebhooksApi extends runtime.BaseAPI {
     ...
     * Create a Webhook
     */
    async createWebhookRaw(requestParameters: CreateWebhookRequest): Promise<runtime.ApiResponse<CreateWebhookResponseBody>> {
        if (requestParameters.createWebhookRequestBody === null || requestParameters.createWebhookRequestBody === undefined) {
            throw new runtime.RequiredError('createWebhookRequestBody','Required parameter requestParameters.createWebhookRequestBody was null or undefined when calling createWebhook.');
        }
        ...
        const response = await this.request({
            ...
            body: CreateWebhookRequestBodyToJSON(requestParameters.createWebhookRequestBody),
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateWebhookResponseBodyFromJSON(jsonValue));
    }
     ...
     * Create a Webhook
     */
    async createWebhook(requestParameters: CreateWebhookRequest): Promise<CreateWebhookResponseBody> {
     ...
     * Get Webhook By ID
     */
    async getWebhookByIdRaw(requestParameters: GetWebhookByIdRequest): Promise<runtime.ApiResponse<GetWebhookByIdResponseBody>> {
        if (requestParameters.webhookId === null || requestParameters.webhookId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetWebhookByIdResponseBodyFromJSON(jsonValue));
    }
     ...
     * Get Webhook By ID
     */
    async getWebhookById(requestParameters: GetWebhookByIdRequest): Promise<GetWebhookByIdResponseBody> {
     ...
     * List Webhooks
     */
    async listWebhooksRaw(): Promise<runtime.ApiResponse<Array<Webhook>>> {
        const queryParameters: any = {};
    ...
    async updateWebhookRaw(requestParameters: UpdateWebhookRequest): Promise<runtime.ApiResponse<string>> {
        ...
        if (requestParameters.updateWebhookRequestBody === null || requestParameters.updateWebhookRequestBody === undefined) {
            throw new runtime.RequiredError('updateWebhookRequestBody','Required parameter requestParameters.updateWebhookRequestBody was null or undefined when calling updateWebhook.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateWebhookRequestBodyToJSON(requestParameters.updateWebhookRequestBody),
        });
