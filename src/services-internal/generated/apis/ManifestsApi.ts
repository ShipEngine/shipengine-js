...
import {
    ...
    CreateManifestRequestBodyFromJSON,
    CreateManifestRequestBodyToJSON,
    CreateManifestResponseBody,
    CreateManifestResponseBodyFromJSON,
    CreateManifestResponseBodyToJSON,
    ErrorResponseBody,
    ErrorResponseBodyFromJSON,
    ErrorResponseBodyToJSON,
    GetManifestByIdResponseBody,
    GetManifestByIdResponseBodyFromJSON,
    GetManifestByIdResponseBodyToJSON,
    ListManifestsResponseBody,
    ListManifestsResponseBodyFromJSON,
    ListManifestsResponseBodyToJSON,
} from '../models';
...
export class ManifestsApi extends runtime.BaseAPI {
     ...
     * Create Manifest
     */
    async createManifestRaw(requestParameters: CreateManifestRequest): Promise<runtime.ApiResponse<CreateManifestResponseBody>> {
        if (requestParameters.createManifestRequestBody === null || requestParameters.createManifestRequestBody === undefined) {
            throw new runtime.RequiredError('createManifestRequestBody','Required parameter requestParameters.createManifestRequestBody was null or undefined when calling createManifest.');
        }
        ...
        const response = await this.request({
            ...
            body: CreateManifestRequestBodyToJSON(requestParameters.createManifestRequestBody),
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateManifestResponseBodyFromJSON(jsonValue));
    }
     ...
     * Create Manifest
     */
    async createManifest(requestParameters: CreateManifestRequest): Promise<CreateManifestResponseBody> {
     ...
     * Get Manifest By Id
     */
    async getManifestByIdRaw(requestParameters: GetManifestByIdRequest): Promise<runtime.ApiResponse<GetManifestByIdResponseBody>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetManifestByIdResponseBodyFromJSON(jsonValue));
    }
     ...
     * Get Manifest By Id
     */
    async getManifestById(requestParameters: GetManifestByIdRequest): Promise<GetManifestByIdResponseBody> {
     ...
     * List Manifests
     */
    async listManifestsRaw(requestParameters: ListManifestsRequest): Promise<runtime.ApiResponse<ListManifestsResponseBody>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListManifestsResponseBodyFromJSON(jsonValue));
    }
     ...
     * List Manifests
     */
    async listManifests(requestParameters: ListManifestsRequest): Promise<ListManifestsResponseBody> {
