...
export function UpdateWebhookRequestBodyFromJSON(json: any): UpdateWebhookRequestBody {
    return UpdateWebhookRequestBodyFromJSONTyped(json, false);
}

export function UpdateWebhookRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateWebhookRequestBody {
...
export function UpdateWebhookRequestBodyToJSON(value?: UpdateWebhookRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
