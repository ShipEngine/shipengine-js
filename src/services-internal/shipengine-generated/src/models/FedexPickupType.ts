...
export function FedexPickupTypeFromJSON(json: any): FedexPickupType {
    return FedexPickupTypeFromJSONTyped(json, false);
}

export function FedexPickupTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FedexPickupType {
    return json as FedexPickupType;
}

export function FedexPickupTypeToJSON(value?: FedexPickupType | null): any {
    return value as any;
}
