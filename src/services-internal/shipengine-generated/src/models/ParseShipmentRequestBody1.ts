 ...
 * @export
 * @interface ParseShipmentRequestBody1
 */
export interface ParseShipmentRequestBody1 {
    /**
     * The unstructured text that contains shipping-related entities
     * @type {string}
     * @memberof ParseShipmentRequestBody1
     */
    text: string;
    /**
...
export function ParseShipmentRequestBody1FromJSON(json: any): ParseShipmentRequestBody1 {
    return ParseShipmentRequestBody1FromJSONTyped(json, false);
}

export function ParseShipmentRequestBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseShipmentRequestBody1 {
...
export function ParseShipmentRequestBody1ToJSON(value?: ParseShipmentRequestBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
