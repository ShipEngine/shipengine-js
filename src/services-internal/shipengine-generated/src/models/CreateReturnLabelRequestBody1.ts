 ...
 * @export
 * @interface CreateReturnLabelRequestBody1
 */
export interface CreateReturnLabelRequestBody1 {
    /**
     * The label charge event.
     * @type {string}
     * @memberof CreateReturnLabelRequestBody1
     */
    chargeEvent?: string;
    /**
...
export function CreateReturnLabelRequestBody1FromJSON(json: any): CreateReturnLabelRequestBody1 {
    return CreateReturnLabelRequestBody1FromJSONTyped(json, false);
}

export function CreateReturnLabelRequestBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateReturnLabelRequestBody1 {
...
export function CreateReturnLabelRequestBody1ToJSON(value?: CreateReturnLabelRequestBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
