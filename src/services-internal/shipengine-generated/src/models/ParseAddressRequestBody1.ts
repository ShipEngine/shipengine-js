 ...
 * @export
 * @interface ParseAddressRequestBody1
 */
export interface ParseAddressRequestBody1 {
    /**
     * The unstructured text that contains address-related entities
     * @type {string}
     * @memberof ParseAddressRequestBody1
     */
    text: string;
    /**
...
export function ParseAddressRequestBody1FromJSON(json: any): ParseAddressRequestBody1 {
    return ParseAddressRequestBody1FromJSONTyped(json, false);
}

export function ParseAddressRequestBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseAddressRequestBody1 {
...
export function ParseAddressRequestBody1ToJSON(value?: ParseAddressRequestBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
