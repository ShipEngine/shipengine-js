 ...
 * @export
 * @interface ParseShipmentResponseBody1
 */
export interface ParseShipmentResponseBody1 {
    /**
     * A confidence score between zero and one that indicates how certain the API is that it understood the text.
     * @type {number}
     * @memberof ParseShipmentResponseBody1
     */
    score: number;
    /**
...
export function ParseShipmentResponseBody1FromJSON(json: any): ParseShipmentResponseBody1 {
    return ParseShipmentResponseBody1FromJSONTyped(json, false);
}

export function ParseShipmentResponseBody1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ParseShipmentResponseBody1 {
...
export function ParseShipmentResponseBody1ToJSON(value?: ParseShipmentResponseBody1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
