 ...
 * @export
 * @interface CustomsItem1
 */
export interface CustomsItem1 {
    /**
     * A string that uniquely identifies the customs item
     * @type {string}
     * @memberof CustomsItem1
     */
...
export function CustomsItem1FromJSON(json: any): CustomsItem1 {
    return CustomsItem1FromJSONTyped(json, false);
}

export function CustomsItem1FromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomsItem1 {
...
export function CustomsItem1ToJSON(value?: CustomsItem1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
