...
import {
    ...
    UpdateShipmentFields1,
    UpdateShipmentFields1FromJSON,
    UpdateShipmentFields1FromJSONTyped,
    UpdateShipmentFields1ToJSON,
} from './';
...
export function UpdateShipmentRequestBodyFromJSON(json: any): UpdateShipmentRequestBody {
    return UpdateShipmentRequestBodyFromJSONTyped(json, false);
}

export function UpdateShipmentRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateShipmentRequestBody {
...
export function UpdateShipmentRequestBodyToJSON(value?: UpdateShipmentRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
