...
export function Manifest1FromJSON(json: any): Manifest1 {
    return Manifest1FromJSONTyped(json, false);
}

export function Manifest1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Manifest1 {
...
export function Manifest1ToJSON(value?: Manifest1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
