 ...
 * @export
 * @interface PackageType1
 */
export interface PackageType1 {
    /**
     * A string that uniquely identifies the package.
     * @type {string}
     * @memberof PackageType1
     */
    packageId?: string;
    /**
     * 
...
export function PackageType1FromJSON(json: any): PackageType1 {
    return PackageType1FromJSONTyped(json, false);
}

export function PackageType1FromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageType1 {
...
export function PackageType1ToJSON(value?: PackageType1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
