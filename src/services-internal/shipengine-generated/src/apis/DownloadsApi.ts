...
export class DownloadsApi extends runtime.BaseAPI {
    ...
    async downloadFileRaw(requestParameters: DownloadFileRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.subdir === null || requestParameters.subdir === undefined) {
            throw new runtime.RequiredError('subdir','Required parameter requestParameters.subdir was null or undefined when calling downloadFile.');
        }
        ...
        if (requestParameters.dir === null || requestParameters.dir === undefined) {
            throw new runtime.RequiredError('dir','Required parameter requestParameters.dir was null or undefined when calling downloadFile.');
        }
        ...
        if (requestParameters.rotation !== undefined) {
            queryParameters['rotation'] = requestParameters.rotation;
        }
        ...
        const response = await this.request({
            path: `/v1/downloads/{dir}/{subdir}/{filename}`.replace(`{${"subdir"}}`, encodeURIComponent(String(requestParameters.subdir))).replace(`{${"filename"}}`, encodeURIComponent(String(requestParameters.filename))).replace(`{${"dir"}}`, encodeURIComponent(String(requestParameters.dir))),
            method: 'GET',
