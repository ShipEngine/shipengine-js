...
export class RatesApi extends runtime.BaseAPI {
     ...
     * Get Shipping Rates
     */
    async calculateRatesRaw(requestParameters: CalculateRatesRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.uNKNOWNBASETYPE === null || requestParameters.uNKNOWNBASETYPE === undefined) {
            throw new runtime.RequiredError('uNKNOWNBASETYPE','Required parameter requestParameters.uNKNOWNBASETYPE was null or undefined when calling calculateRates.');
        }
     ...
     * Get Shipping Rates
     */
    async calculateRates(requestParameters: CalculateRatesRequest): Promise<object> {
     ...
     * Get Bulk Rates
     */
    async compareBulkRatesRaw(requestParameters: CompareBulkRatesRequest): Promise<runtime.ApiResponse<Array<BulkRate1>>> {
        if (requestParameters.uNKNOWNBASETYPE === null || requestParameters.uNKNOWNBASETYPE === undefined) {
            throw new runtime.RequiredError('uNKNOWNBASETYPE','Required parameter requestParameters.uNKNOWNBASETYPE was null or undefined when calling compareBulkRates.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(BulkRate1FromJSON));
    }
     ...
     * Get Bulk Rates
     */
    async compareBulkRates(requestParameters: CompareBulkRatesRequest): Promise<Array<BulkRate1>> {
     ...
     * Estimate Rates
     */
    async estimateRatesRaw(requestParameters: EstimateRatesRequest): Promise<runtime.ApiResponse<Array<object>>> {
        if (requestParameters.uNKNOWNBASETYPE === null || requestParameters.uNKNOWNBASETYPE === undefined) {
            throw new runtime.RequiredError('uNKNOWNBASETYPE','Required parameter requestParameters.uNKNOWNBASETYPE was null or undefined when calling estimateRates.');
        }
     ...
     * Estimate Rates
     */
    async estimateRates(requestParameters: EstimateRatesRequest): Promise<Array<object>> {
     ...
     * Get Rate By ID
     */
    async getRateByIdRaw(requestParameters: GetRateByIdRequest): Promise<runtime.ApiResponse<object>> {
     ...
     * Get Rate By ID
     */
    async getRateById(requestParameters: GetRateByIdRequest): Promise<object> {
