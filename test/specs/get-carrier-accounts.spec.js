...
describe("getCarrierAccounts()", () => {
  ...
  it("Multiple Accounts", async function () {
    let accounts;
  ...
  it("Server-side error", async function () {
...
const accountData = [
  {
    ...
    carrier: { name: "United Parcel Service", code: "ups" },
    accountNumber: "1169350",
    name: "My UPS Account",
  },
  {
    id: "car_2aca9f662b71be73e7b36",
    carrier: { name: "Federal Express", code: "fedex" },
  ...
  {
    id: "car_1knseddGBrseWTIw",
    carrier: { name: "", code: "usps" },
    accountNumber: "46-751-342556",
    name: "My USPS Account",
  },
  {
    id: "car_d1dcrTN3c86Wpcfd82d161",
    carrier: { name: "United States Postal Service", code: "stamps_com" },
