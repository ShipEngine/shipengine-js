...
describe("validateAddress()", () => {
  ...
  it("Validates a commercial address", async () => {
    ...
    const addressToValidate = {
      name: "John Smith",
      company: "ShipStation",
      addressLineOne: "3800 N Lamar Blvd",
      addressLineTwo: "#220",
      cityLocality: "Austin",
      stateProvince: "TX",
      postalCode: "78756",
    ...
    expect(result).to.deep.equal({
      ...
      normalizedAddress: {
        name: "JOHN SMITH",
        company: "SHIPSTATION",
        addressLineOne: "3800 N LAMAR BLVD STE 220",
        addressLineTwo: "",
        addressLineThree: "",
        cityLocality: "AUSTIN",
        stateProvince: "TX",
  ...
  it("Validates an address with messages", async () => {
    ...
    const addressToValidate = {
      name: "John Smith",
      addressLineOne: "Winchester Blvd",
  ...
  it("Throws an error if no address lines are provided", async () => {
    ...
    try {
      ...
      errors.assertShipEngineError(error, {
        ...
        message: "Invalid address. The addressLineOne must be specified.",
      });
